...
public class Fragment_Data_Podcast_Download {
	int _id;
	String title; 
	String enclosure;
	String pubDate;
	...
	String provider;
	public Fragment_Data_Podcast_Download(int _id, String title, String enclosure, String pubDate, String image, String description_title, String provider){
		this._id = _id;
		this.title = title;
